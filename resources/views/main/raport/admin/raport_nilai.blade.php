...
@section('content-title')
    <div class="d-flex justify-content-between align-items-center">
        <h4 class="mb-0">Halaman Raport Nilai</h4>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex justify-content-between">
                        <p class="mb-0 font-weight-bold" style="font-size: 18px">Nilai Rata - Rata</p>
                        <p class="mb-0 font-weight-bold" id="nilai" style="font-size: 18px">0</p>
                    </div>
                    <hr/>
    ...
    <script>
        ...
        async function getDetail(id, kelas) {
            ...
            try {
                ...
                if (payload.length > 0) {
                    ...
                    el.append('<tr>' +
                        '<td colspan="3" class="font-weight-bold text-center">Belum Ada Mata Pelajaran</td>' +
                        '</tr>');
                }
                let total_nilai = payload.length > 0 ? payload.reduce((n, {nilai}) => n + (nilai === null ? 0 : nilai.nilai), 0) : 0;
        ...
        $(document).ready(function () {
                ...
                columns: [
                    ...
                    {data: 'rata_rata'},
                    {
                        data: null, render: function (data, type, row, meta) {
                            return '<a href="#" data-id="' + data['id'] + '" data-kelas="' + kelas+ '" class="btn btn-primary btn-sm text-center btn-detail">detail</a>';
                        }
                    },
                ],
                paging: true,
            ...
            $('#btn-cetak').on('click', function (e) {
                ...
                let id = this.dataset.id;
                let kelas = this.dataset.kelas;
                window.location.href = '/raport-anak/cetak?siswa=' + id + '&periode=' + periode + '&semester=' + semester + '&kelas=' + kelas;
            })
        });
    </script>
@endsection
